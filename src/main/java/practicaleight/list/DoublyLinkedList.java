...
public class DoublyLinkedList<E> {
  ...
  public E removeLast() {
    ...
    // Reminder: refer to the textbook and your notes for details
    // Reminder: refer to the assignment sheet on the web site for ideas
    return null;
  }
  ...
  public boolean equals(Object list) {
    // TODO: Add a complete implementation of the equals method
    // Reminder: Please see the assignment sheet, README, and the textbook
    // for more details about how to correctly implement this method
    // Reminder: Don't forget that you have already seen an implementation
    // of this method for a SinglyLinkedList. How do you think that the
    // previous implementation needs to be updated for this method?
    return true;
  }

  /**
   * Produces a hashCode (i.e., a unique number) of the DoublyLinkedList.
   * @return the unique numerical value for this instance of DoublyLinkedList
   */
  public int hashCode() {
    int hashCodeValue = 0;
    for (Node<?> walk = header; walk != null; walk = walk.getNext()) {
  ...
  public static void main(String[] args) {
    ...
    // TODO: Add the required output statements to ensure that your
    // program produces textual output demonstrating correctness
    // Reminder: refer to the assignment sheet on the course web site
    // or the README in your repository for more details on the output
  }
